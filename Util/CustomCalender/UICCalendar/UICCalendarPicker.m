...
//		[self.prevButton setFrame:CGRectMake(8.0f, 6.0f, controlButtonWidth[viewSize], controlButtonHeight[viewSize])];
		[self.prevButton setFrame:CGRectMake(62.0f, 15.0f, 46, 30)];
...
//		[self.nextButton setFrame:CGRectMake(self.frame.size.width - 63.0f - viewSize * 3, 6.0f, controlButtonWidth[viewSize], controlButtonHeight[viewSize])];
		[self.nextButton setFrame:CGRectMake(self.frame.size.width - 95.0f - viewSize * 3, 15.0f, 46, 30)];
		...
		[self.prevYearButton setFrame:CGRectMake(8.0f, 15.0f, 46, 30)];
		...
		[self.nextYearButton setFrame:CGRectMake(self.frame.size.width - 41.0f - viewSize * 3, 15.0f, 46, 30)];
